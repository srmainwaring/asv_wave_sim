...
class IWaveField1
{
 public:
  ...
  ///
  /// \return A shared pointer to the wave parameters.
  virtual std::shared_ptr<const WaveParameters> GetParameters() const = 0;

  /// \brief Set the wave parameters.
  ///
  /// \param[in] value
  ///   The wave parameters.
  virtual void SetParameters(std::shared_ptr<const WaveParameters> value) = 0;
};
