...
class WaveSimulationOpenCLImpl
{
  ...
  public: WaveSimulationOpenCLImpl(int N, double L);

  public: virtual void SetTime(double _time);
  ...
  complex Htilde0(double k, double kx, double ky, double u, double ux, double uy, complex gz);
...
WaveSimulationOpenCLImpl::WaveSimulationOpenCLImpl(int N, double L) :
  mN(N),
  mN2(N * N),
  mNOver2(N / 2),
  mL(L),
...
void WaveSimulationOpenCLImpl::ComputeHeightsDerivatives(
  std::vector<double>& _dhdx,
  std::vector<double>& _dhdy)
{
  // Logging
...
void WaveSimulationOpenCLImpl::ComputeCurrentAmplitudes(double time)
{

}

complex WaveSimulationOpenCLImpl::Htilde0(double k, double kx, double ky, double u, double ux, double uy, complex gz)
{
...
WaveSimulationOpenCL::WaveSimulationOpenCL(int N, double L) :
  impl(new WaveSimulationOpenCLImpl(N, L))
{
}

void WaveSimulationOpenCL::SetTime(double _time)
{
  return impl->SetTime(_time);
}

void WaveSimulationOpenCL::ComputeHeights(
  std::vector<double>& _h)
{
  return impl->ComputeHeights(_h);    
}

void WaveSimulationOpenCL::ComputeHeightsDerivatives(
  std::vector<double>& _dhdx,
  std::vector<double>& _dhdy)
{
  return impl->ComputeHeightsDerivatives(_dhdx, _dhdy);  
}
...
void WaveSimulationOpenCL::ComputeDisplacements(
  ...
  std::vector<double>& _sy)
{
  return impl->ComputeHeightsDerivatives(_sx, _sy);    
}
...
void WaveSimulationOpenCL::ComputeDisplacementDerivatives(
  ...
  std::vector<double>& _dsxdy)
{
  return impl->ComputeDisplacementDerivatives(_dsxdx, _dsydy, _dsxdy);      
}